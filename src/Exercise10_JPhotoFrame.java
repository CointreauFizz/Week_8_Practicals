...
public class Exercise10_JPhotoFrame extends JFrame implements ItemListener {
    ...
    {
        Exercise10_JPhotoFrame frame = new Exercise10_JPhotoFrame();
