...
public class Exercise9_JDorm2 extends JFrame implements ItemListener {
    ...
    String output;
    int x;
    public Exercise9_JDorm2()
    {
        setTitle("Dorm Room Options");
    ...
    {
        Exercise9_JDorm2 dFrame = new Exercise9_JDorm2();
